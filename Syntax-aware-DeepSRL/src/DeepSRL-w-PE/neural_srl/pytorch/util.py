...
def batch_data_variable(corpus_pattern, batch_position_encoding, batch_x, batch_y, batch_lengths, batch_weights):
    ...
    return words, predicates, pattern, li_syntactic_label, la_syntactic_label, lp_syntactic_label, \
           labels, torch.LongTensor(lengths), masks, padding_answers
