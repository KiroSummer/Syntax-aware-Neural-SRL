...
def get_scores(config, task, model_path, word_dict_path, label_dict_path, syn_label_dict_path, input_path):
    ...
    with Timer('Running model'):
        ...
        for i, batched_tensor in enumerate(test_data):
            ...
            word_inputs_seqs, predicate_inputs_seqs, syn_label_ids, pes, sentences_ids, answers, input_lengths, masks, padding_answers = \
                batch_data_variable(test_dep_trees, x, y, lengths, weights)
            ...
            sc = model.forward(word_inputs_seqs, predicate_inputs_seqs, syn_label_ids, pes, elmo_representations,
                                   input_lengths)
...
if __name__ == "__main__":
    ...
    for i in range(num_ensemble_models):
        ...
        print("model dict path: {}, word dict path: {}, label dict path: {}, syn_label_dict: {}".format( \
            model_path, word_dict_path, label_dict_path, syn_label_dict_path))
